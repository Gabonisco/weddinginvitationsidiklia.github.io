(()=>{var __webpack_modules__=({"../demo6/src/js/components/blockui.js":/*!*********************************************!*\
!*** ../demo6/src/js/components/blockui.js ***!
\*********************************************/((module)=>{"use strict";var KTBlockUI=function(element,options){var the=this;if(typeof element==="undefined"||element===null){return;}
...
if(true&&typeof module.exports!=='undefined'){module.exports=KTBlockUI;}}),"../demo6/src/js/components/cookie.js":/*!********************************************!*\
!*** ../demo6/src/js/components/cookie.js ***!
\********************************************/((module)=>{"use strict";var KTCookie=function(){return{get:function(name){var matches=document.cookie.match(new RegExp("(?:^|; )"+name.replace(/([\.$?*|{}\(\)\[\]\\\/\+^])/g,'\\$1')+"=([^;]*)"));return matches?decodeURIComponent(matches[1]):null;},set:function(name,value,options){if(typeof options==="undefined"||options===null){options={};}
...
document.cookie=updatedCookie;},remove:function(name){this.set(name,"",{'max-age':-1});}}}();if(true&&typeof module.exports!=='undefined'){module.exports=KTCookie;}}),"../demo6/src/js/components/dialer.js":/*!********************************************!*\
!*** ../demo6/src/js/components/dialer.js ***!
\********************************************/((module)=>{"use strict";var KTDialer=function(element,options){var the=this;if(!element){return;}
...
var _handlers=function(){KTUtil.addEvent(the.incElement,'click',function(e){e.preventDefault();_increase();});KTUtil.addEvent(the.decElement,'click',function(e){e.preventDefault();_decrease();});KTUtil.addEvent(the.inputElement,'change',function(e){e.preventDefault();_setValue();});}
...
var _decrease=function(){KTEventHandler.trigger(the.element,'kt.dialer.decrease',the);the.inputElement.value=the.value-the.options.step;_setValue();KTEventHandler.trigger(the.element,'kt.dialer.decreased',the);return the;}
var _setValue=function(){KTEventHandler.trigger(the.element,'kt.dialer.change',the);the.value=parseFloat(the.inputElement.value.replace(/[^\d.]/g,''));if(the.value<the.options.min){the.value=the.options.min;}
if(the.value>the.options.max){the.value=the.options.max;}
the.inputElement.value=_format(the.value);KTEventHandler.trigger(the.element,'kt.dialer.changed',the);}
var _format=function(val){return the.options.prefix+parseFloat(val).toFixed(the.options.decimals)+the.options.suffix;}
...
if(true&&typeof module.exports!=='undefined'){module.exports=KTDialer;}}),"../demo6/src/js/components/drawer.js":/*!********************************************!*\
!*** ../demo6/src/js/components/drawer.js ***!
\********************************************/((module)=>{"use strict";var KTDrawer=function(element,options){var the=this;var body=document.getElementsByTagName("BODY")[0];if(typeof element==="undefined"||element===null){return;}
...
if(true&&typeof module.exports!=='undefined'){module.exports=KTDrawer;}}),"../demo6/src/js/components/event-handler.js":/*!***************************************************!*\
!*** ../demo6/src/js/components/event-handler.js ***!
\***************************************************/((module)=>{"use strict";var KTEventHandler=function(){var _handlers={};var _triggerEvent=function(element,name,target,e){if(KTUtil.data(element).has(name)===true){var handlerId=KTUtil.data(element).get(name);if(_handlers[name]&&_handlers[name][handlerId]){var handler=_handlers[name][handlerId];if(handler.name===name){if(handler.one==true){if(handler.fired==false){_handlers[name][handlerId].fired=true;return handler.callback.call(this,target,e);}}else{return handler.callback.call(this,target,e);}}}}
return null;}
...
return{trigger:function(element,name,target,e){return _triggerEvent(element,name,target,e);},on:function(element,name,handler){return _addEvent(element,name,handler);},one:function(element,name,handler){return _addEvent(element,name,handler,true);},off:function(element,name){return _removeEvent(element,name);},debug:function(){for(var b in _handlers){if(_handlers.hasOwnProperty(b))console.log(b);}}}}();if(true&&typeof module.exports!=='undefined'){module.exports=KTEventHandler;}}),"../demo6/src/js/components/feedback.js":/*!**********************************************!*\
!*** ../demo6/src/js/components/feedback.js ***!
\**********************************************/((module)=>{"use strict";var KTFeedback=function(options){var the=this;var body=document.getElementsByTagName("BODY")[0];var defaultOptions={'width':100,'placement':'top-center','content':'','type':'popup'};var _construct=function(){_init();}
...
the.one=function(name,handler){return KTEventHandler.one(the.element,name,handler);}
the.off=function(name){return KTEventHandler.off(the.element,name);}
the.trigger=function(name,event){return KTEventHandler.trigger(the.element,name,event,the,event);}};if(true&&typeof module.exports!=='undefined'){module.exports=KTFeedback;}}),"../demo6/src/js/components/image-input.js":/*!*************************************************!*\
!*** ../demo6/src/js/components/image-input.js ***!
\*************************************************/((module)=>{"use strict";var KTImageInput=function(element,options){var the=this;if(typeof element==="undefined"||element===null){return;}
...
if(true&&typeof module.exports!=='undefined'){module.exports=KTImageInput;}}),"../demo6/src/js/components/menu.js":/*!******************************************!*\
!*** ../demo6/src/js/components/menu.js ***!
\******************************************/((module)=>{"use strict";var KTMenu=function(element,options){var the=this;if(typeof element==="undefined"||element===null){return;}
...
if(true&&typeof module.exports!=='undefined'){module.exports=KTMenu;}}),"../demo6/src/js/components/password-meter.js":/*!****************************************************!*\
!*** ../demo6/src/js/components/password-meter.js ***!
\****************************************************/((module)=>{"use strict";var KTPasswordMeter=function(element,options){var the=this;if(!element){return;}
...
var _checkChar=function(){return /[~`!#$%\^&*+=\-\[\]\\';,/{}|\\":<>\?]/g.test(the.inputElement.value);}
...
if(true&&typeof module.exports!=='undefined'){module.exports=KTPasswordMeter;}}),"../demo6/src/js/components/scroll.js":/*!********************************************!*\
!*** ../demo6/src/js/components/scroll.js ***!
\********************************************/((module)=>{"use strict";var KTScroll=function(element,options){var the=this;var body=document.getElementsByTagName("BODY")[0];if(!element){return;}
...
if(true&&typeof module.exports!=='undefined'){module.exports=KTScroll;}}),"../demo6/src/js/components/scrolltop.js":/*!***********************************************!*\
!*** ../demo6/src/js/components/scrolltop.js ***!
\***********************************************/((module)=>{"use strict";var KTScrolltop=function(element,options){var the=this;var body=document.getElementsByTagName("BODY")[0];if(typeof element==="undefined"||element===null){return;}
...
if(true&&typeof module.exports!=='undefined'){module.exports=KTScrolltop;}}),"../demo6/src/js/components/search.js":/*!********************************************!*\
!*** ../demo6/src/js/components/search.js ***!
\********************************************/((module)=>{"use strict";var KTSearch=function(element,options){var the=this;if(!element){return;}
...
if(the.toolbarElement){the.toolbarElement.classList.add("d-none");}
...
if(the.toolbarElement){the.toolbarElement.classList.remove("d-none");}
...
if(true&&typeof module.exports!=='undefined'){module.exports=KTSearch;}}),"../demo6/src/js/components/stepper.js":/*!*********************************************!*\
!*** ../demo6/src/js/components/stepper.js ***!
\*********************************************/((module)=>{"use strict";var KTStepper=function(element,options){var the=this;var body=document.getElementsByTagName("BODY")[0];if(typeof element==="undefined"||element===null){return;}
...
if(true&&typeof module.exports!=='undefined'){module.exports=KTStepper;}}),"../demo6/src/js/components/sticky.js":/*!********************************************!*\
!*** ../demo6/src/js/components/sticky.js ***!
\********************************************/((module)=>{"use strict";var KTSticky=function(element,options){var the=this;var body=document.getElementsByTagName("BODY")[0];if(typeof element==="undefined"||element===null){return;}
var defaultOptions={offset:200,flipOffset:0,reverse:false,animation:true,animationSpeed:'0.3s',animationClass:'animation-slide-in-down'};var _construct=function(){if(KTUtil.data(element).has('sticky')===true){the=KTUtil.data(element).get('sticky');}else{_init();}}
...
var _scroll=function(e){var offset=_getOption('offset');var reverse=_getOption('reverse');var st;var attrName;var diff;if(offset===false){return;}
offset=parseInt(offset);st=KTUtil.getScrollTop();if(reverse===true){if(st>offset){if(body.hasAttribute(the.attributeName)===false){_enable();body.setAttribute(the.attributeName,'on');}
...
the.lastScrollTop=st;}else{if(st>offset){if(body.hasAttribute(the.attributeName)===false){_enable();body.setAttribute(the.attributeName,'on');}
if(the.eventTriggerState===true){KTEventHandler.trigger(the.element,'kt.sticky.on',the);KTEventHandler.trigger(the.element,'kt.sticky.change',the);the.eventTriggerState=false;}}else{if(body.hasAttribute(the.attributeName)===true){_disable();body.removeAttribute(the.attributeName);}
if(the.eventTriggerState===false){KTEventHandler.trigger(the.element,'kt.sticky.off',the);KTEventHandler.trigger(the.element,'kt.sticky.change',the);the.eventTriggerState=true;}}}}
...
var _flip=function(){var flipOffset=_getOption('flip-offset');var flipBottom=_getOption('flip-bottom');var diff=document.documentElement.scrollHeight-window.innerHeight-KTUtil.getScrollTop();flipOffset=parseInt(flipOffset);if(flipOffset>0){if(diff>=flipOffset){KTUtil.css(the.element,'top',top);KTUtil.css(the.element,'bottom','auto');}else{KTUtil.css(the.element,'top','auto');KTUtil.css(the.element,'bottom',flipBottom);}}}
...
if(true&&typeof module.exports!=='undefined'){module.exports=KTSticky;}}),"../demo6/src/js/components/swapper.js":/*!*********************************************!*\
!*** ../demo6/src/js/components/swapper.js ***!
\*********************************************/((module)=>{"use strict";var KTSwapper=function(element,options){var the=this;if(typeof element==="undefined"||element===null){return;}
...
if(true&&typeof module.exports!=='undefined'){module.exports=KTSwapper;}}),"../demo6/src/js/components/toggle.js":/*!********************************************!*\
!*** ../demo6/src/js/components/toggle.js ***!
\********************************************/((module)=>{"use strict";var KTToggle=function(element,options){var the=this;var body=document.getElementsByTagName("BODY")[0];if(!element){return;}
...
if(true&&typeof module.exports!=='undefined'){module.exports=KTToggle;}}),"../demo6/src/js/components/util.js":/*!******************************************!*\
!*** ../demo6/src/js/components/util.js ***!
\******************************************/((module)=>{"use strict";if(!Element.prototype.matches){Element.prototype.matches=function(s){var matches=(this.document||this.ownerDocument).querySelectorAll(s),i=matches.length;while(--i>=0&&matches.item(i)!==this){}
return i>-1;};}
...
return hex;},isInViewport:function(element){var rect=element.getBoundingClientRect();return(rect.top>=0&&rect.left>=0&&rect.bottom<=(window.innerHeight||document.documentElement.clientHeight)&&rect.right<=(window.innerWidth||document.documentElement.clientWidth));},onDOMContentLoaded:function(callback){if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',callback);}else{callback();}},inIframe:function(){try{return window.self!==window.top;}catch(e){return true;}}}}();if(true&&typeof module.exports!=='undefined'){module.exports=KTUtil;}}),"../demo6/src/js/layout/app.js":/*!*************************************!*\
!*** ../demo6/src/js/layout/app.js ***!
\*************************************/((module)=>{"use strict";var KTApp=function(){var initPageLoader=function(){KTUtil.removeClass(document.body,'page-loading');}
...
handleToggle();}};}();KTUtil.onDOMContentLoaded(function(){KTLayoutAside.init();});}),"../demo6/src/js/layout/explore.js":/*!*****************************************!*\
!*** ../demo6/src/js/layout/explore.js ***!
\*****************************************/(()=>{"use strict";var KTLayoutExplore=function(){var explore;return{init:function(){explore=document.querySelector('#kt_explore');if(!explore){return;}}};}();KTUtil.onDOMContentLoaded(function(){KTLayoutExplore.init();});}),"../demo6/src/js/layout/search.js":/*!****************************************!*\
...
initForm();}};}();KTUtil.onDOMContentLoaded(function(){KTLayoutToolbar.init();});})});var __webpack_module_cache__={};function __webpack_require__(moduleId){var cachedModule=__webpack_module_cache__[moduleId];if(cachedModule!==undefined){return cachedModule.exports;}
var module=__webpack_module_cache__[moduleId]={exports:{}};__webpack_modules__[moduleId](module,module.exports,__webpack_require__);return module.exports;}
var __webpack_exports__={};(()=>{/*!**********************************!*\
!*** ./webpack/scripts.demo6.js ***!
\**********************************/window.KTUtil=__webpack_require__(/*!@/src/js/components/util.js*/"../demo6/src/js/components/util.js");window.KTBlockUI=__webpack_require__(/*!@/src/js/components/blockui.js*/"../demo6/src/js/components/blockui.js");window.KTCookie=__webpack_require__(/*!@/src/js/components/cookie.js*/"../demo6/src/js/components/cookie.js");window.KTDialer=__webpack_require__(/*!@/src/js/components/dialer.js*/"../demo6/src/js/components/dialer.js");window.KTDrawer=__webpack_require__(/*!@/src/js/components/drawer.js*/"../demo6/src/js/components/drawer.js");window.KTEventHandler=__webpack_require__(/*!@/src/js/components/event-handler.js*/"../demo6/src/js/components/event-handler.js");window.KTFeedback=__webpack_require__(/*!@/src/js/components/feedback.js*/"../demo6/src/js/components/feedback.js");window.KTImageInput=__webpack_require__(/*!@/src/js/components/image-input.js*/"../demo6/src/js/components/image-input.js");window.KTMenu=__webpack_require__(/*!@/src/js/components/menu.js*/"../demo6/src/js/components/menu.js");window.KTPasswordMeter=__webpack_require__(/*!@/src/js/components/password-meter.js*/"../demo6/src/js/components/password-meter.js");window.KTScroll=__webpack_require__(/*!@/src/js/components/scroll.js*/"../demo6/src/js/components/scroll.js");window.KTScrolltop=__webpack_require__(/*!@/src/js/components/scrolltop.js*/"../demo6/src/js/components/scrolltop.js");window.KTSearch=__webpack_require__(/*!@/src/js/components/search.js*/"../demo6/src/js/components/search.js");window.KTStepper=__webpack_require__(/*!@/src/js/components/stepper.js*/"../demo6/src/js/components/stepper.js");window.KTSticky=__webpack_require__(/*!@/src/js/components/sticky.js*/"../demo6/src/js/components/sticky.js");window.KTSwapper=__webpack_require__(/*!@/src/js/components/swapper.js*/"../demo6/src/js/components/swapper.js");window.KTToggle=__webpack_require__(/*!@/src/js/components/toggle.js*/"../demo6/src/js/components/toggle.js");window.KTApp=__webpack_require__(/*!@/src/js/layout/app.js*/"../demo6/src/js/layout/app.js");window.KTLayoutAside=__webpack_require__(/*!@/src/js/layout/aside.js*/"../demo6/src/js/layout/aside.js");window.KTLayoutExplore=__webpack_require__(/*!@/src/js/layout/explore.js*/"../demo6/src/js/layout/explore.js");window.KTLayoutSearch=__webpack_require__(/*!@/src/js/layout/search.js*/"../demo6/src/js/layout/search.js");window.KTLayoutToolbar=__webpack_require__(/*!@/src/js/layout/toolbar.js*/"../demo6/src/js/layout/toolbar.js");})();})();